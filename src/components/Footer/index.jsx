  ...
  return (
    <footer className="lg:px-5 md:px-5 px-2 z-[5]">
      <div className="flex mb-1 min-h-[120px]">
        <div className="flex flex-col justify-center">
          <div className="md:inline-flex hidden cursor-pointer">
            <Link to="/home">
              <img loading="lazy" alt="logo" className="mx-3 h-[60px]" src={logo} />
            </Link>
          </div>
          <div className="md:hidden inline-flex cursor-pointer" >
            <Link to="/home">
              <img loading="lazy" alt="logo" className="mx-3 h-[40px]" src={logo} />
            </Link>
          </div>
        </div>
        ...
        <div className="p-3 flex flex-col justify-between">
          <div className="flex pt-2 pb-1">
            <div>
              ...
              <br />
              <span className="text-lg text-gray-100 font-semibold"><span
                style={{ fontWeight: 'bolder', color: '#5de4b5' }}>Mix</span>Anime</span>
            </div>
      ...
      <div className="mx-5 py-3">
        ...
        <div className="mt-4">
          <p className="text-gray-100 mb-5 px-1"><small>Mix Anime does not store any files on our server, we only
